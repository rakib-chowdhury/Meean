...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        var data = [
            {label: "Product", data: <?= $product_number[0]['p_count']; ?>, color: "#68BC31"},
            {label: "Trade Show", data: <?= $market_number[0]['m_count']; ?>, color: "#2091CF"},
            {label: "Marketplace", data: <?= $trade_number[0]['t_count']; ?>, color: "#AF4E96"},
        ]
...
<script>
    /*$("#fileupload").on("change", function() {
     if($("#fileupload")[0].files.length > 2); {
