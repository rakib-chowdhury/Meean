            ...
            <div class="col-xs-12 col-sm-12 col-md-8 company_contact" style="background-color: rgb(247, 248, 246);">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Subject</label>
                        ...
                        <div class="col-sm-10">
                            <input id="subject" value="<?= $select_company[0]['product_name']; ?>" required type="text" name="subject" placeholder="Mail Subject" class="form-control custom-control" style="border: 1px solid rgb(204, 204, 204);margin-bottom:5px;"/>
                        </div>
