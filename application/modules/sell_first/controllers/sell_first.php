...
class Sell_first extends CI_Controller {
    //put your code here
  ...
  function __construct() {
        ...
        $this->load->model('sell_first_model');
    }
    ...
    public function index() {
        ...
        $data['news_feed']=  $this->sell_first_model->select_news_feed();
        $this->load->view('market_place/market_content/market_header',$data);
        $this->load->view('how_to_sell_first');
