                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form name="myForm" class="form-horizontal" action="<?php echo site_url('buyer/insert_product'); ?>" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input id="form-field-1" onblur="show_en_first_name_msg()" name="product_quantity" placeholder="Product Quantity" class="col-xs-10 col-sm-5" type="number" min="1" >
