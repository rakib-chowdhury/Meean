						...
						<div class="page-content">
							...
							<div class="page-header">
								<h1 style="text-align:center;">
									Auto generating Mail speech
								</h1>
							</div><!-- /.page-header -->
							<div class="row">
									<!-- PAGE CONTENT BEGINS -->
									<form class="form-horizontal" role="form" class="col-sm-6" action="admin/update_mail_speech" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<div class="col-sm-6	">
												...
												<tr>	
													<td>
														<div onblur="myclick()" class="wysiwyg-editor" name="description" id="editor1"><?=$all_mail_speech_info->description;?></div>
