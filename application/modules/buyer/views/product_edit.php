            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <form name="myForm" class="form-horizontal" action="buyer/update_product_details/<?= $p_details[0]['product_id']; ?>" method="post" enctype="multipart/form-data">
...
<!--<textarea  style="resize:none" name="product_description" id="form-field-1" cols="30" placeholder="Product Description" class="col-xs-10 col-sm-5" rows="10"><?= $p_details[0]['market_place_description']; ?></textarea>
                                        ...
                                        <div onblur="myclick()" class="wysiwyg-editor" name="product_description" id="editor1"><?= $p_details[0]['product_description']; ?></div>

                                        <script type="text/javascript">
                                            var $path_assets = "dist";
                                        </script>

                                        <input type="hidden" name="product_description" id="desvalue" value="<?= $p_details[0]['product_description']; ?>">
                                    </div>
                                </div>
...
//                alert(images_table_id);
                ...
                $.ajax({
                    url: "<?php echo site_url('buyer/image_details_modal'); ?>",
                    type: "post",
...
//                var gpf_id= document.getElementById('gpf_id').value;
                ...
                //alert(url_for_reload);
                $.ajax({
                    url: "<?php echo site_url('buyer/sub_image_details_modal'); ?>",
                    type: "post",
