											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<?php $i=1;foreach($all_product_info as $row):?>
													<tr>
														...
														<td class="hidden-480">
															<?php if($row->market_place_is_block==0){echo '<span class="label label-sm label-success">Active';}else{echo '<span class="label label-sm label-warning">inactive';}?></span>
														</td>
