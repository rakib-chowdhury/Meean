                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form name="myForm" class="form-horizontal" action="buyer/update_market_product_details	/<?=$p_details[0]['market_place_id'];?>" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input id="form-field-1" value="<?=$p_details[0]['market_place_location'];?>" onblur="show_en_first_name_msg()" name="product_location" placeholder="Product Location" class="col-xs-10 col-sm-5" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
													...
													<?php if($sub_category_name[0]['market_sub_cat_id']!=''){ ?>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-6">
													...
													<div onblur="myclick()" class="wysiwyg-editor" name="description" id="editor1"><?=$p_details[0]['market_place_description'];?></div>
                                            ...
                                            <button style="margin-left:46.5%;" class="btn btn-info" type="submit" name="btn">
											 ...
											 <a href="buyer/all_market_product" class="btn btn-danger">
