            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <form name="myForm" class="form-horizontal" action="<?php echo site_url('seller/insert_product'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input id="form-field-1"  name="payment_method" placeholder="Payment Type" class="col-xs-10 col-sm-5" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="form-field-1" onblur="show_en_first_name_msg()" name="product_model" placeholder="Product Model" class="col-xs-10 col-sm-5" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="form-field-1" onblur="show_en_first_name_msg()" name="product_size" placeholder="Product Size" class="col-xs-10 col-sm-5" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="form-field-1" onblur="show_en_first_name_msg()" name="product_quantity" placeholder="Product Quantity" class="col-xs-10 col-sm-5" type="text"  >
...
<div class="col-sm-9">
<select name="business_type" id="sub_category" style="width: 41.5%;" required>
...
<option value="Distributer/Whole Seller">Distributer/Whole Seller</option>  
<option value="Manufacter">Manufacter</option>  
<option value="Other">Other</option>  
                                 ...
                                 <div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Main Market</label>

<div class="col-sm-9">
<input type="checkbox" name="market_type" value="America">America &nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" name="market_type" value="Asia">Asia&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" name="market_type" value="Europe">Europe<br>
                                                <input type="checkbox" name="market_type" value="Middleast">Middleast&nbsp;&nbsp;
                                                <input type="checkbox" name="market_type" value="Africa">Africa&nbsp;&nbsp;
                                                <input type="checkbox" name="market_type" value="Occania">Occania<br>
                                                <input type="checkbox" name="market_type" value="Carabian">Carabian&nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" name="market_type" value="World Wide">World Wide<br>
</div>
...
<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Company Employee :</label>

<div class="col-sm-9">
<input id="form-field-1" onblur="show_en_first_name_msg()" name="company" placeholder="Product Quantity" class="col-xs-10 col-sm-5" type="text"  >
