                ...
                <div class="main-content-inner">
                    ...
                    function sendData()
                    {
                        ...
                        <div class="row">
                            ...
                            <!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" role="form" class="col-sm-6" action="admin/insert_promote_your_ad" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"></label>
                                    <div class="col-sm-6">
                                            ...
                                            <tr>	
                                                <td>
                                                    <div onblur="myclick()" class="wysiwyg-editor" name="description" id="editor1">
                                                        <?php if($promote_ad){echo $promote_ad->promote_ad_description;} ?>
                                                    </div>
