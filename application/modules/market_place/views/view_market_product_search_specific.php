...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
        ...
        <div class="row">
            ...
            <!--<div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <?php foreach ($category_ad as $row) { ?>
                        <div id="image_banner">
                            <img class="img-responsive" style="width:100%;height:110px" src="uploads/market_category/<?= $row->market_image; ?>" alt="Add">
                        </div>
            ...
            <div class="col-xs-12" style="margin-top: 10px">
                <?php foreach ($advertise as $row) {
                    if ($row['post_name'] == 'market page filter top') { ?>

                        <a target="_blank" href="<?= $row['link']; ?>"><img style=" width: 100%;height:110px;"
					...
					<?php if (file_exists($file_url . '' . $row1['market_place_image'])) { ?>
                                ...
                                <div class="col-xs-6 col-md-6 market_place_description">
                                    ...
                                    <?php if ($row1['members_status'] == 1) { ?>
                                        <p style="border: 1px solid grey;padding: 5px;margin-top: 15px;background-color: grey;color: black;border-radius: 5px;width: 50%">
                                            Members</p>
                                    <?php } ?>
                                </div>
 ...
 <?php if (file_exists($file_url . '' . $row->market_place_image)) { ?>
            ...
            <div class="col-xs-12 col-sm-3 col-md-2 advertise">
                <?php foreach ($advertise as $row) {
                    if ($row['post_name'] == 'market page filter right(1st position)') { ?>
        ...
        <div class="col-md-8 description" style="border:2px solid #e4e4e4;padding: 10px;  background-color: #fff;">
            ...
            <div class="col-md-12 text-center" style="color:red;display:block">
                <a style="color:black;font-weight: bold;"
                   class="btn btn-warning" <?php if ($this->session->userdata('type') == 4) {
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <center><a href="market_place/post_add">
                        <button type="button" class="btn btn-success" value="login">Login</button>
                    </a>
