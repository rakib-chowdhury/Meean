...
class Stay_safe extends CI_Controller {
    //put your code here
  ...
  function __construct() {
        ...
        $this->load->model('stay_safe_model');
    }
    ...
    public function index() {
        ...
        $data['news_feed']=  $this->stay_safe_model->select_news_feed();
        $this->load->view('market_place/market_content/market_header',$data);
        $this->load->view('view_stay_safe_page');
