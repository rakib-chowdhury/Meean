    ...
    <div class="container" style="padding: 0px;">
        <div class="row">
            ...
            <!--
                <div id="image_banner">
                <?php if ($category_id) { ?>
                                <a target="_blank" href="#"><img class="img-responsive" style="width:100%;height:110px" src="uploads/market_category/<?= $category_ad->market_image; ?>" alt="Add"></a>
                <?php } ?>
                    </div> -->
            ...
            <div class="col-xs-12 col-sm-6 col-md-7 market_place">
                ...
                <?php
                if (count($select_product_by_location) >= 1) {
                ...
                foreach ($select_product_by_location as $row) {
                ?>
            ...
            <div class="col-xs-12 col-sm-3 col-md-2 advertise">
                <?php foreach ($advertise as $row) {
                    if ($row['post_name'] == 'market page location wise right(1st position)') {
                        ?>

                        <a target="_blank" href="<?= $row['link']; ?>"><img style="margin-top:-45px; width: 100%;margin-bottom:60px;height:500px;" src="uploads/<?= $row['image']; ?>" alt="Add"></a>
            ...
            <?php foreach ($advertise as $row) {
                if ($row['post_name'] == 'market page location wise right(2nd position)') {
                    ?>

                    <div class="col-xs-12 col-sm-3 col-md-2 advertise">

                        <a target="_blank" href="<?= $row['link']; ?>"><img style="margin-top:-45px; width: 100%;height:500px;" src="uploads/<?= $row['image']; ?>" alt="Addddd"></a>
        ...
        <div class="row" style="margin-top: -109px;">
            <div class="col-md-3 description" style=""></div>
            <div  class="col-md-9 description" style="border:2px solid #e4e4e4;padding: 10px;  background-color: #fff;">
                ...
                <div class="col-md-12 text-center" style="color:red;display:block">
                    <a style="color:black;font-weight: bold;" class="btn btn-warning" <?php
                    if ($this->session->userdata('type') == 4) {
                        echo "href='market/add_market_place_product'";
                    } else {
                        ?> data-toggle="modal" data-target="#my_modal" <?php } ?> >Post a free AD <!-- iti -->
                    </a>
