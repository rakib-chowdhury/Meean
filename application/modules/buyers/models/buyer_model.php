...
class Buyer_model extends CI_Model
{
    ...
    public function select_buyer_by_id($cat_id) {
         $this->db->select('reg.*, cat.*,pro.*');
        $this->db->from('registration reg');
        $this->db->join('category cat', 'cat.cat_id = reg.industry_name','Left'); 
        $this->db->join('product pro', 'pro.reg_id = reg.reg_id','Left');
    ...
    public function select_buyer_by_id_pagination($cat_id,$limit,$start) {
    ...
    public function select_buyer_details_by_id($reg_id) {
