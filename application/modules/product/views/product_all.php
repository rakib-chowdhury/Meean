    ...
    <div class="container">
        <div class="row">    
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 homebanner-holder">
              ...
              <?php foreach($advertise as $row){ if($row['post_name']=='product page banner'){?>
	      ...
	      <?php break; } } ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 homebanner-holder">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12" >
                    <div id="hero">
                        <h1 id="abcd" style="font-size: 22px;">A B C D</h1>
                        <div class="col-xs-10 col-sm-10" id="line-separatore"></div>
                        <div class="A_Div" style="">
                            
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            <a href="product/product_by_category/1">Agriculture</a>
                            ...
                            <div class="list-group" id="agriculture_list">
                                <ul>
                                    ...
                                    $count = 0;
                                        ...
                                        if ($count ==4) { break; }
                                        ?>
                                    <li><a href="product/all_product/<?php echo $row->sub_cat_id ?>" class=" text-center"><?php echo $row->sub_cat_name?></a></li>
                                       <?php 
                                        $count++;
                                        }
                                        ?>
                       ...
                       <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            <a href="product/product_by_category/2">Apparel & cloth</a>
            ...
            <div class="info-boxes wow fadeInUp">
                <div class="info-boxes-inner">
                 <?php foreach($advertise as $row){ if($row['post_name']=='product page top right(1st position)'){?>
