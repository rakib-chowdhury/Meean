        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3">
                <ul class="list-unstyled footer_list">
                    ...
                    <li>
                        <a href="support">Membership</a> <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="active" href="stay_safe"><strong>Stay safe on meeean.com</strong></a><i class="fa fa-angle-right"></i>
                    </li>
                    <li>
            ...
            <div class="col-xs-12 col-sm-6 col-md-9">
                <section id="description">
                    <h2><?=$stay_safe->stay_safe_description;?> </h2>
                </section>
            </div>
        </div>
    </div>
