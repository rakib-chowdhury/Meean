...
<?php } ?>
                            ...
                            <!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" role="form" class="col-sm-6" action="admin/update_hiring" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"></label>
                                    <div class="col-sm-6	">
                                        <table class="table table-bordered">
                                            <tr>	
                                                <td>
                                                    <div onblur="myclick()" class="wysiwyg-editor" name="description" id="editor1"><?= $all_hiring_info->description; ?></div>
