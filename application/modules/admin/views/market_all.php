											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>Product Name</th>
														<th>Price</th>
														<th class="hidden-480" style="width:10%;">Category</th>
														<th class="hidden-480" style="width:10%;">Sub Category</th>
												...
												<?php $i=1;$j=1; foreach($all_product_info as $row):?>
													<tr>
														...
														<td class="hidden-480">
															<?php if($row->market_place_is_block==0){echo '<span class="label label-sm label-success">Active';}else{echo '<span class="label label-sm label-warning">inactive';}?>
														</td>

														<td>
															<?php if($row->market_place_is_block==0){echo '<a  href="admin/update_market_product/'.$row->market_place_id.'" type="button" class="btn btn-warning btn-xs">Inactive</a>';} else{echo '<a href="admin/update_market_product/'.$row->market_place_id.'" type="button" class="btn btn-success btn-xs">Active</a>';}?>
															<?php if($row->is_feature==1){echo '<a  href="admin/update_product_market_feature/'.$row->market_place_id.'" type="button" class="btn btn-warning btn-xs">Featuring Inactive</a>';} else{echo '<a href="admin/update_product_market_feature/'.$row->market_place_id.'" type="button" class="btn btn-success btn-xs">FeatureActive</a>';}?>
