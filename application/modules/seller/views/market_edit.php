                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form name="myForm" class="form-horizontal" action="seller/update_market_product_details	/<?=$p_details[0]['market_place_id'];?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <button style="margin-left:46.5%;" class="btn btn-info" type="submit" name="btn">
											 ...
											 <a href="seller/all_market_product" class="btn btn-danger">
