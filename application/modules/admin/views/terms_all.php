                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <table class="table table-bordered">
                                                    ...
                                                    <div>
                                                        <div class="upload_div">
                                                            <form name="posting_comment" id="posting_comment" >
                                                                <input id="file_upload" name="attachment_file" onchange = "sendData()" class="file_upload_icon" type="file"/>
                                                                <hr>
                                            ...
                                            <tr>
                                                <td><?php $i = 0; ?>
                                                    <a href="admin/see_it" data-toggle="modal" data-target="#myModal<?php
                                                    echo $i;
                                                    $i++;
                                                    ?>">See Images</a>
...
<?php } ?>
                            ...
                            <!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" role="form" class="col-sm-6" action="admin/update_terms" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"></label>
                                    <div class="col-sm-6	">
                                        <table class="table table-bordered">
                                            <tr>	
                                                <td>
                                                    <div onblur="myclick()" class="wysiwyg-editor" name="description" id="editor1"><?= $all_terms_info->description; ?></div>
