    ...
    <div class="container">
        <div class="row">    
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 homebanner-holder">
                <?php foreach($advertise as $row){ if($row['post_name']=='buyers page banner'){?>
                            ...
                            <div class="list-group" id="agriculture_list">
                                <ul>
                                    ...
                                    $count = 0;
                                        ...
                                        if ($count ==4) { break; }
                                        ?>
                                    <li><a href="buyers/select_buyer/<?php echo $row->cat_id ?>" class=" text-center"><?php echo $row->sub_cat_name?></a></li>
                                       <?php 
                                        $count++;
                                        }
                                        ?>
                ...
                <section id="featured_product" class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                   ...
                   <?php foreach($feature_product_1 as $row){ ?>
                    <div class="col-xs-6 col-md-6 featured">
                       <a href="buyers/buyer_detail/<?=$row['product_id']?>">
