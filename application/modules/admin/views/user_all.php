                                        ...
                                        foreach ($all_user_info as $row): ?>
                                            ...
                                            $i++; ?>
                                                ...
                                                <?php if ($row->is_block == 1) {
                                                    echo '<a  href="admin/update_user/' . $row->login_id . '"><span class="label label-sm label-success">Active</span></a>';
                                                } else {
                                                    echo '<a href="admin/update_user/' . $row->login_id . '"><span class="label label-sm label-warning">Inactive</span></a>';
                                                } ?>
                                                    
                                                    <?php if ($row->members_status == 0) {
                                                    echo '<a  href="admin/update_members/' . $row->id . '"><span class="label label-sm label-warning">Unblock</span></a>';
                                                } else {
                                                    echo '<a href="admin/update_members/' . $row->id . '"><span class="label label-sm label-success">Block</span></a>';
                                                } ?>
