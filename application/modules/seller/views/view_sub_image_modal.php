<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form action="seller/update_sub_image" method="post" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <?php foreach ($image_details as $row){?>
             ...
             <input type="hidden" name="images_id" value="<?php echo $row['images_id'];?>">
             <input type="hidden" name="images_table_id" value="<?php echo $row['images_table_id'];?>">
            <div class="form-group">
                <label for="name">Product Image:</label>
                <img src="assets/product_images/<?= $row['images_name']; ?>" style="width: 100px;height: 100px">
            </div>
