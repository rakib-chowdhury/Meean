    ...
    <div class="container">
        <div class="row">
	      ...
	      <?php break; } } ?>
            ...
            <div class="col-md-12" style="margin-top:10px;">
                ...
                <div id="image_banner">
                    <img class="img-responsive" style="width:100%;height:300px;" src="uploads/trade/<?=$trade_info[0]['image'];?>" alt="Add">
                </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8">
                ...
                <h1 style="font-size: 30px;text-align:center;"><?=$trade_info[0]['name'];?></h1>
                </div>
                <div class="jumbotron">
                    <h2 style="font-size: 25px;text-align:center;">Venue <b>:</b> <?=$trade_info[0]['venue'];?></h2>
                     <br/>
                    <p style="text-align:justify;"> About <?=$trade_info[0]['name'];?> <b>:</b> <?=$trade_info[0]['description'];?></p>
                </div>
		...
		<?php } } ?>
                 <section id="featured_product" class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <?php if($row['image']!=$trade_info[0]['image']) { ?>
